...
```bash
git clone https://github.com/Nikhil20012/eeg-seizure-detection.git
...
4. Open the notebook in Google Colab or Jupyter and upload the data files when prompted
...
- Andrzejak RG, Lehnertz K, Mormann F, Rieke C, David P, Elger CE (2001). Indications of nonlinear deterministic and finite-dimensional structures in time series of brain electrical activity. Physical Review E, 64(6), 061907.
